...
namespace PlayingForKeepers.Pages.Administration
{
    ...
    [BindProperties]
    public class DeleteUserRoleModel : DI_BasePageModel
    {
        ...
        public DeleteUserRoleModel(PlayingForKeepersDbContext context, IAuthorizationService authorizationService, UserManager<IdentityUser> userManager, RoleManager<IdentityRole> roleManager)
        ...
        public async Task<IActionResult> OnPostDeleteUserRoleAsync(string roleId)
        {
