...
namespace PlayingForKeepers.Pages.Leagues
{
    ...
    public class LeagueActivityModel : DI_BasePageModel
    {
        ...
        public LeagueActivityModel(PlayingForKeepersDbContext context, IAuthorizationService authorizationService, UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager)
