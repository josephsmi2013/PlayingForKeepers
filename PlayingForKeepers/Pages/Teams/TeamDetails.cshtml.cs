...
namespace PlayingForKeepers.Pages.Teams
{
    public class TeamDetailsModel : DI_BasePageModel
    {
        ...
        public TeamDetailsModel(PlayingForKeepersDbContext context, IAuthorizationService authorizationService, UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager)
